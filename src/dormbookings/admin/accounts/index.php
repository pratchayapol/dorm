...
<div class="card card-outline rounded-0 card-maroon">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=accounts/manage_account" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  เพิ่มผู้เข้าพัก</a>
		</div>
	</div>
	<div class="card-body">
			...
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<thead>
					<tr>
						<th>eeลำดับ</th>
						<th>วันที่บันทึก</th>
						<th>รหัสนักศึกษา/เลขบัตร ปชช.</th>
						<th>ชื่อ-สกุล</th>
						<th>หอพัก</th>
						<th>สถานะ</th>
						<th>การจัดการ</th>
