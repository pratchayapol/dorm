...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">จำนวนห้องทั้งหมด</span>
          <span class="info-box-number text-right">
            <?php 
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">นักศึกษาและผู้เข้าพักทั้งหมด</span>
          <span class="info-box-number text-right">
            <?php 
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">นักศึกษาและผู้เข้าพักปัจจุบัน</span>
          <span class="info-box-number text-right">
            <?php 
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">รายการใช้จ่ายเดือนนี้</span>
          <span class="info-box-number text-right">
            <?php 
