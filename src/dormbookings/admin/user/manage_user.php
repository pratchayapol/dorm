...
<div class="card card-outline rounded-0 card-maroon">
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
                ...
                <div class="form-group">
                    <label for="type" class="control-label">ชนิดผู้ใช้งาน</label>
				...
				<div class="form-group">
					<label for="" class="control-label">ภาพ</label>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary rounded-0 mr-3" form="manage-user">บันทึกข้อมูล</button>
					<a href="./?page=user/list" class="btn btn-sm btn-default border rounded-0" form="manage-user"><i class="fa fa-angle-left"></i> ยกเลิก</a>
				</div>
			</div>
		</div>
</div>
